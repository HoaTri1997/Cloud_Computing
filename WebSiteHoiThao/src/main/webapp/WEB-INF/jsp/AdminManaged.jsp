				...
				<ul class="nav navbar-nav pull-right">
					...
					<li class="dropdown dropdown-user"><a href="#"
						...
						<ul class="dropdown-menu dropdown-menu-default">
							...
							<li><a href="${contextPath}/dangxuat"> <i class="icon-key"></i> Log
									Out
							</a></li>
						</ul></li>
							...
							<div class="portlet-body">
								<div class="table-toolbar">
									<div class="row">
										<div class="col-md-6">
											<div class="btn-group">
												<a id="new" class="btn green" href="add-article"> Add
								...
								<table class="table table-striped table-hover table-bordered"
									...
									<tbody>
										<c:forEach var="conference" items="${conferences}">
											<tr>
												<td>${conference.id}</td>
												<td>${conference.tieude}</td>
												<td><fmt:formatDate pattern="yyyy-MM-dd HH:mm:ss"
														value="${conference.ngaytao}" /></td>
												<td><a href="update-article?id=${conference.id}"><span
														class="glyphicon glyphicon-pencil"></span></a></td>
												<td><a href="delete-article?id=${conference.id}"><span
